...
class sim_pipe{
        ...
        /**
         * Data Members added by me
         */
        unsigned PC_ADDER;
        int instruction_no=0;
        int no_of_instruction_executed=0;
        int clock_cycles=0;
        bool runcycle=false;
    ...
    /**
* Five structs for 5 pipeline registers
* Save yourself from using arrays
*
*/
    struct
    {
...
public:
	...
	*/
	...
	/**
	 * Functions added by me to the header file
	 */
